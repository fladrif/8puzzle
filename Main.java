	...
	public static void main(String[] args) throws InterruptedException{
		...
		if (dec.toLowerCase().equals("y")) {
			...
			do {
				...
				System.out.println("Nodes generated by Manhattan Distance heuristic: " + manhattanNodes);
				System.out.println("Time taken: " + (endTime - startTime) / 1000000 + "ms");
				startTime = System.nanoTime();
				int misplacedNodes = alg.astarMisplaced(board);
				endTime = System.nanoTime();
				System.out.println("Nodes generated by Misplaced Tile heuristic: " + misplacedNodes);
				System.out.println("Time taken: " + (endTime - startTime) / 1000000 + "ms");
